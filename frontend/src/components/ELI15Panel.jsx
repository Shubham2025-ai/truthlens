    ...
    <div className="bg-[#111] border border-white/10 rounded-2xl p-6 h-full flex flex-col gap-5">
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          ...
          <div className="text-xs font-mono text-white/30 tracking-widest uppercase">Explain Like I'm 15</div>
        </div>
        {eli15 ? (
          <p className="text-sm text-white/75 leading-relaxed">{eli15}</p>
        ) : (
          <p className="text-sm text-white/30">Simplified explanation unavailable.</p>
        )}
      </div>
